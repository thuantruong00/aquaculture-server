...
export class DeviceControlControllerBase extends BaseController {
  ...
  async handleDeviceControlManagementPage(req: Request, res: Response) {
    try {
      const getListOfActiveDevice = await Device.find({
        status: { $eq: DeviceStatus.ACTIVE },
      })
  ...
  async handleDeviceTimerPage(req: Request, res: Response) {
    this.renderWithSidebar(res);
  }
  async handleAutomaticScenePage(req: Request, res: Response) {
    this.renderWithSidebar(res);
  }

  async handleApiControlDevice(req: Request, res: Response) {
    try {
  ...
  async handleApiLogsDevice(req: Request, res: Response) {
    try {
  ...
  async handleApiTelemetry(req: Request, res: Response) {
    try {
